...
floor for reviewers and every repository implementer: reading project
instructions, editing, testing, and reporting are multi-turn work even when
the code change itself is mechanical. Reserve the cheapest tier for one-turn
text transformations that do not read or modify a repository.

**Task complexity signals (implementation tasks):**
- Repository implementation → standard model
